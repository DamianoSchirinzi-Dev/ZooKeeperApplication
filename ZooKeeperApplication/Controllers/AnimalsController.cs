...
namespace ZooKeeperApplication.Controllers
{
    public class AnimalsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Animals != null ? 
                          ...
                          Problem("Entity set 'ZooContext.Animals'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,BirthDate")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,BirthDate")] Animal animal)
        {
            if (id != animal.Id)
            {
                return NotFound();
